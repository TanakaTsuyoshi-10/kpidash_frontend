...
export default function StoreDetailPage({ params }: Props) {
  ...
  const { data, loading, error, setMonth } = useStoreDetail(segmentId, month)
  ...
  const displayMonth = month.substring(0, 7)
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 収支実績 */}
      <StorePLSummaryCard segmentId={segmentId} month={month} />
